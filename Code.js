...
const LOGS_SPREADSHEET_ID = PropertiesService.getScriptProperties().getProperty('LOGS_SPREADSHEET_ID');
const LOG_TO_SHEET = true;
const LOG_PAYLOAD = true;
...
function logToSheet() {
	...
	var sheet = SpreadsheetApp.openById(LOGS_SPREADSHEET_ID).getSheetByName('logs');
